...
def evaluation(args, epoch, test_loader, model, logger, writer, n_iter, mode='Val'):
    ...
    #     m = Chem.MolFromSmiles(label2sf2smi(x[id, 1:].cpu().numpy()))
    #     mols.append(m)
    #     print(epoch, i, id, generated_samples[id], logPs[id])
    #     filepath = '../figure1/' + str(epoch) + str(id) + '_' + str(logPs[id]) + '.png'
    #     # Draw.MolToFile(m, filepath, size=(600, 600))
