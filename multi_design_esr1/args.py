...
def get_args():
    ...
    parser.add_argument('--single_design', default=False, type=bool)
    parser.add_argument('--multi_design', default=True, type=bool)
    ...
    parser.add_argument('--mlp_hidden_dim', default=50, type=int)
