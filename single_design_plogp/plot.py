...
mean = np.zeros(n)
for i in range(50):
    data.append(np.load('two_step/' + str(i) + ".npy"))
...
plt.xlabel("Penalized " + "logP", fontweight='bold', fontsize=15)
g.fig.suptitle('t',
               ha='right',
               fontsize=20,
               fontweight=20)
# plt.xlim(xmin=0)
# plt.show()
plt.savefig("plogp.pdf", dpi=300, bbox_inches='tight')
